...
public class CadastrarUsuarioActivity extends Activity {
		...
		new AsyncTask<Void, Void, String>() {
			...
			protected String doInBackground(Void... params) {
				...
				if (validar == null) {
					...
					// Caso haja algum campo inv�lido
					return validar;
				}
				return null;
			}
	...
	private String validarCampos() {
		...
		// Validando se inseriu um registro acad�mico
		...
		// Se os campos estiverem v�lidos
		return null;
	}
	...
	protected void onDestroy() {
		try {
			...
			Log.e("Conex�o com o Banco de dados no servidor", "Falha ao fechar a conex�o", e);
		}
		super.onDestroy();
	}
}
